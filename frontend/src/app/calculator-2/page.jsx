...
<div className="shadow-md"> 
 ...
 {/* row-4 */}
    ...
    <div className="flex flex-row gap-3.5  p-2 ">
      ...
      <button className="flex-1  flex items-center justify-center w-24 bg-[#DFDFDF] px-4 py-2.5 rounded-lg text-xl font-bold shadow-[0px_2px_4px_0px_rgba(0,0,0,0.25)]"><IconEqual/></button>
    </div>
    </div>
