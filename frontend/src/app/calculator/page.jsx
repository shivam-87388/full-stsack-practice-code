...
const page = () => {
  return (
    <div className="w-[1440px] h-[1024px] p-2.5 bg-zinc-400 inline-flex justify-center items-center gap-2.5 overflow-hidden">
  <div className="w-56 h-[464px] max-w-56 pt-16 pb-2.5 bg-white rounded-xl flex justify-center items-center gap-2.5">
