...
<div className="flex flex-row justify-center items-center gap-3.5">
  <div className="w-8 px-1.5 py-1.5 bg-neutral-200/40 rounded-lg shadow-[0px_2px_4px_0px_rgba(0,0,0,0.25)] flex flex-col justify-center items-center gap-2.5">
    <div className=" text-center justify-start text-black text-xl font-normal font-['Arial_Rounded_MT_Bold']">7</div>
  </div>
  <div className="w-8 px-1.5 py-1.5 bg-neutral-200/40 rounded-lg shadow-[0px_2px_4px_0px_rgba(0,0,0,0.25)] flex flex-col justify-center items-center gap-2.5">
    <div className=" text-center justify-start text-black text-xl font-normal font-['Arial_Rounded_MT_Bold']">8</div>
  </div>
