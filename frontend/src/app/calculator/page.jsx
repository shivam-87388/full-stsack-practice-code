...
const page = () => {
  return (
    <div className="w-full min-h-screen p-2.5 bg-zinc-400 flex justify-center items-center gap-2.5 overflow-hidden">
  ...
  <div className="flex-1 h-64 py-2 bg-white inline-flex flex-col justify-center items-center gap-3.5">
    ...
    <div className="self-stretch inline-flex justify-center items-center gap-3.5">
      ...
      <div className="w-8 px-1.5 py-1.5 bg-orange-500 rounded-lg shadow-[0px_2px_4px_0px_rgba(0,0,0,0.25)] inline-flex flex-col justify-center items-center gap-3.5">
        <div className="self-stretch text-center justify-start text-white text-xl font-normal font-['Arial_Rounded_MT_Bold']">=</div>
      </div>
    </div>
  </div>
</div>  
