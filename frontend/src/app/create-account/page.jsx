    ...
    <div className="flex items-center justify-center min-h-screen">
      ...
      <h1 className="text-white text-2xl font-bold mb-2.5"> Create Account</h1>
        <div className="flex flex-row  gap-3 w-full ">
          ...
          <input onChange={handleChange} name="lastname" placeholder="park" id="lastname" type="text" className="text-xl text-white rounded-md border-2 border-white px-2.5 py-1 w-44"/> 
          </div>
        
        </div>
        <div className="flex flex-col  justify-center w-full">
        <label htmlFor='email' className="text-xl text-white">Email</label>
        <input onChange={handleChange} name="email" placeholder="xyz@gmail.com" id="email" required className="border-2 text-white text-xl border-white rounded-md px-2.5 py-1"/>
        </div>
        <div className="flex flex-col justify-center w-full mb-3">
        <label htmlFor='password' className="text-xl text-white">Password</label>
        <input onChange={handleChange} name="password" placeholder="enter password" id="password" required className="border-2 text-xl text-white border-white rounded-md px-2.5 py-1"/>
        </div>
        <div className="flex flex-col justify-center w-full mb-3">
