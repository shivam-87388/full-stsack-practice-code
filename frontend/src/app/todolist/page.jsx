  ...
  return (
   <div className=" items-center justify-center p-6 -full ">
    ...
    <div className="flex flex-col md:flex-row justify-center items-center gap-4">
      <input onSubmit={handelchange} type="text" placeholder="enter task" className="md:w-lg w-64 py-2.5 px-2.5 text-2xl rounded-lg border-[1.50px] border-black"></input>
