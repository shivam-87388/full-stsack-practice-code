...
import { trash } from "@fortawesome/react-fontawesome"; 
    ...
    <div className="flex flex-col md:flex-row justify-center items-center gap-4">
     ...
     <div className="flex items-center justify-center flex-col gap-4 mt-5 lg:w-1/2 w-full bg-amber-200 rounded-2xl px-4 py-3">
       {tasks.map((item, index) => {
        return <p key={index} className="w-full text-2xl border-2 text-black border-black  rounded-2xl p-2.5 ">{item} <i class="fa-solid fa-trash"></i>  </p>
