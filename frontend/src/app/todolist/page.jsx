  ...
  return (
   ...
   <div className=" items-center justify-center p-6 -full ">
    ...
    <div className="flex flex-col md:flex-row justify-center items-center gap-4">
     ...
     <div className="flex items-center justify-center flex-col gap-4 mt-5 w-full ">
       {tasks.map((item, index) => {
        return <p key={index} className="text-2xl border-2 text-white border-white w-3/5 rounded-2xl p-2.5 ">{item}</p>
